...
export default function Hero() {
    return (
        ...
        <section className="hero max-w-3xl w-max-sm sm:max-w-xl gap-6 mx-auto justify-center items-center sm:items-start mt-32 sm:mt-48 flex flex-col-reverse sm:flex-row ">
            <div className={"w-[50%] max-w-[50%] flex flex-col"}>
                ...
                <p className="mt-4 font-medium leading-relaxed text-black max-w-xl">
